...
abstract class DynPro[Decision] extends DynProMatrix {
   ...
   */
  val matrixForwardPathBackward = true
  ...
  lazy val matrix: Array[Array[Option[Double]]] = {
    var mx: Array[Array[Option[Double]]] = Array.ofDim(n, m)
   ...
   * @return
   */
  protected[gumbix] def calcMatrixIndexValue(currentMX: Array[Array[Option[Double]]],
                       idx: Idx,
