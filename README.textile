...
Highlights so far
* generic (2D) dynamic programing algorithm (see net.gumbix.paradynpro.DynPro)
...
* Pattern recognization with the Viterbi-algorithm (hidden markov model, see net.gumbix.parabioinf.hmm.Viterbi)
